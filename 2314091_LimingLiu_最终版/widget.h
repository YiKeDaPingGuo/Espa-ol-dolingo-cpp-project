...
class Widget : public QWidget
{
    ...
    QList<QPushButton*> m_ImageButtons;
...
protected:
    ...
    void dialogFourFront(std::function<void()> callback);//同步执行
