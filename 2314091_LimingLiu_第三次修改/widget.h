...
class Widget : public QWidget
{
    ...
    QList<QStringList> m_allChoiceAnswers2;
...
protected:
    ...
    void setButton(QString sentence, QWidget *dialog, int x, int y, int length, int width,bool isDelete, std::function<void()> onClicked = nullptr);
