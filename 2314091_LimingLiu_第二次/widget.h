...
protected:
    ...
    void setButton(QString sentence, QWidget *dialog, int x, int y, int length, int width, std::function<void()> onClicked = nullptr);
    ...
    void setSchedule(WordDatabase mdb);
    void playSound(QWidget * dialog,QString resourcePath);
    void setWords(QStringList sentence, QWidget *dialog,int x,int y,int size);
    void ChallengeTwo();
